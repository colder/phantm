...
\begin{thebibliography}{99}
  ...
  \bibitem{tapl}Benjamin C. Pierce {\it Types and Programming Languages}
    The MIT Press (2002)
  \bibitem{aliasanal}N. Jovanovic, C. Kruegel, E. Kirda {\it Precise Alias Analysis for Static Detection of Web Application Vulnerabilities}
    Technical University of Vienna
  \bibitem{diminfer}S. Hangal, M.S. Lam {\it Automatic Dimension Inference and Checking for Object-Oriented Programs}
